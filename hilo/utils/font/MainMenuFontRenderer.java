...
public class MainMenuFontRenderer {
    ...
    private java.awt.Font getFontByName(String name) throws IOException, FontFormatException {
        if (name.equalsIgnoreCase("hilo"))
            return getFontFromInput("/assets/minecraft/hilo/fonts/TitilliumWeb-ExtraLight.ttf");
        else
            return getFontFromInput("/assets/minecraft/hilo/fonts/Quicksand-Regular.ttf");
    }
