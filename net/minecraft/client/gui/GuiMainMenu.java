...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    protected static final ResourceLocation fontLocation = new ResourceLocation("hilo/fonts/Quicksand-Regular.ttf");
	
   	/** Fonts **/
   	public static final hilo.font.FontRenderer font = new hilo.font.FontRenderer(fontLocation, 90);
   	public static final hilo.font.FontRenderer font2 = new hilo.font.FontRenderer(fontLocation, 20);
    ...
    private static final ResourceLocation background = new ResourceLocation("hilo/bg.png");
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
    	...
    	font.drawCenteredStringWithShadow(Hilo.name, width/2f, height/5f, -1);
